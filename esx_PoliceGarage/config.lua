...
Config.PoliceVehicles = {
		...
		{ model = 'police', label = 'Mercedess Cadet LSPD'},
		{ model = 'police2', label = 'Dodge Charger LSPD'},
		{ model = 'police3', label = 'Ford Interceptor LSPD'},
		{ model = 'ghispo2', label = 'Maseratti LSPD'},
		{ model = 'police4', label = 'CVPI Unemarked'},
		{ model = 'fbi2', label = 'Tahoe Unemarked'},
		{ model = 'fbi', label = 'Buffalo Banalisé'},
		{ model = '', label = '-----Motos--------'},		
